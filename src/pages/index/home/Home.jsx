...
import {Carousel, message, Modal, Form, Input, Button, DatePicker, Checkbox} from 'antd';
...
import wx from '../../../common/images/wx.png'
...
class Home extends Component {
    ...
    render() {
        ...
        let {bannerList, serveList, newEnergyList, centerList, currentImgUrl, currentTitle, visible, reserveForm} = this.state;
        return (
            <div className="home-box">
                    ...
                    <Carousel autoplay effect="fade">
                        {
                            bannerList.map(banner =>{
                                return <div key={banner.id} className='banner-box'>
                                    <Lazy className="img" src={banner.url}/>
                                </div>
                            })
                        }
                    </Carousel>
                ...
                <div className="newEnergy">
                    <div className="inner-box">
                        <TitleItem en={'NEW ENERGY'} zh={'新能源指标延期'} />
                        <ul>
                            {
                ...
                <div className="center">
                    <div className="inner-box">
                        <TitleItem en={'TRAFFIC'} zh={'车务中心'} />
                        <ul>
                            {
                                centerList.map(center =>{
                                    return <li key={center.title}>
                                        <div onClick={() => this.showBigImg()}>
                ...
                <div className="contact-us">
                    <div className="inner-box">
                        <TitleItem en={'CONTACT US'} zh={'联系我们'} />
